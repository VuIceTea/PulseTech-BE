...
export const listBrandsHandler: RequestHandler = async (_req, res) => {
  const brands = await brandService.listBrands();
  res.status(200).json({ data: brands });
};

export const listAdminBrandsHandler: RequestHandler = async (_req, res) => {
  const brands = await brandService.listBrands({ includeInactive: true });
  res.status(200).json({ data: brands });
};

export const createBrandHandler: RequestHandler = async (req, res) => {
  try {
...
export const updateBrandHandler: RequestHandler = async (req, res) => {
  try {
...
export const deleteBrandHandler: RequestHandler = async (req, res) => {
  try {
    const id = parseId(req.params.id);
...
export const restoreBrandHandler: RequestHandler = async (req, res) => {
  try {
    const id = parseId(req.params.id);
...
export const hardDeleteBrandHandler: RequestHandler = async (req, res) => {
  try {
    const id = parseId(req.params.id);
