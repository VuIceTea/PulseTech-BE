...
export type CouponOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "code" | "discountValue" | "description" | "discountType" | "validFrom" | "validTo" | "usageLimit" | "usedCount" | "isActive", ExtArgs["result"]["coupon"]>;
